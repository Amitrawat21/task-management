...
export const getMyUsers = createAsyncThunk(
  ...
  async ({ userId, adminId }, thunkAPI) => {
    try {
      ...
      const response = await axios.put(`https://task-management-3-8mok.onrender.com/user/addUser/${adminId}`, { userId });
...
export const getUser = createAsyncThunk(
    ...
    async ({  adminId }, thunkAPI) => {
      try {
        ...
        const response = await axios.get(`https://task-management-3-8mok.onrender.com/user/adminUser/${adminId}`);
  ...
  export const getAdminTask = createAsyncThunk(
    ...
    async ({  adminId }, thunkAPI) => {
      try {
        ...
        const response = await axios.get(`https://task-management-3-8mok.onrender.com/task/adminAllUser/${adminId}`);
